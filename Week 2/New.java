...
public class New {
    public static void main(String[] args) {
        try (/* Qno.1 Write a program to check whether a person can cast a vote or not. 
            ...
            double roll_number = task.nextDouble();
            task.nextLine();
            ...
            double breadth = task.nextDouble();
            double Area1 = len*breadth;
            ...
            System.out.println("Enter a marks of subject four:");
            ...
            String nik = (n>=70) ? "First Class":
                         ...
                         (n>=49) ? " Second Class":
                         (n>=39) ? "Third Class":"fail";
            System.err.println(nik);
